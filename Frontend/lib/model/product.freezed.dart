...
class _$_Product implements _Product {
  ...
  int get hashCode => Object.hash(
      ...
      stack_status,
      product_id,
      const DeepCollectionEquality().hash(_product_ids));
...
abstract class _Product implements Product {
  factory _Product(
      ...
      final List<String>? product_ids}) = _$_Product;
